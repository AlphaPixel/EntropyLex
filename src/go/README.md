...
Dictionary loaders must support canonical LXJ (`.lxj`). LXB (`.lxb`) is an optional compiled representation; a loader that supports it must confirm the same dictionary fingerprint and behavior as LXJ. See ../../data/dict/FORMAT.md.
